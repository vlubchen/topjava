...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    void registerNotValid() throws Exception {
        UserTo newUser = new UserTo(null, null, null, null, 0);
    ...
    void updateNotValid() throws Exception {
        UserTo updatedTo = new UserTo(null, "u", "user@yandex.ru", "password", 1);
    ...
    void updateDuplicateEmail() throws Exception {
        UserTo updatedTo = new UserTo(null, "newName", "admin@gmail.com", "password", 500);
        perform(MockMvcRequestBuilders.put(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .with(userHttpBasic(user))
                .content(JsonUtil.writeValue(updatedTo)))
