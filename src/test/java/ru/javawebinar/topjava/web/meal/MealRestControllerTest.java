...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void updateNotValid() throws Exception {
        Meal updateMeal = new Meal(MEAL1_ID, null, null, 500);
    ...
    void updateDuplicateDateTime() throws Exception {
        Meal updateMeal = new Meal(MEAL1_ID, meal2.getDateTime(), "UpdateMeal", 500);
        perform(MockMvcRequestBuilders.put(REST_URL + MEAL1_ID)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(updateMeal))
                .with(userHttpBasic(user)))
    ...
    void createNotValid() throws Exception {
        Meal newMeal = new Meal(null, null, "notValidData", 500);
    ...
    void createDuplicateDateTime() throws Exception {
        Meal newMeal = new Meal(null, meal1.getDateTime(), "NewMeal", 500);
        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(newMeal))
                .with(userHttpBasic(user)))
